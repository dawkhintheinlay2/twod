...
// FIX: မိတ်ဆွေရဲ့ Account စာရင်းထဲမှာ ရှိတဲ့ Model အတိအကျကိုပဲ သုံးပါမည်
const AI_MODELS = [
    "gemini-2.0-flash",       // မိတ်ဆွေစာရင်းထဲမှာ ပါသည်
    "gemini-2.0-flash-exp",   // မိတ်ဆွေစာရင်းထဲမှာ ပါသည်
